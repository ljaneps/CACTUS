...
class Subtopic(Base):
    ...
    subtopic_code = Column(Integer, primary_key=True,
                           index=True, autoincrement=True)
    topic_code = Column(Integer, ForeignKey(
        "topics.topic_code"), nullable=False)
...
class Flashcard(Base):
    ...
    flashcard_code = Column(Integer, primary_key=True,
                            index=True, autoincrement=True)
    subtopic_code = Column(Integer, ForeignKey(
        "subtopics.subtopic_code"), nullable=False)
...
class Question(Base):
    ...
    question_code = Column(Integer, primary_key=True,
                           index=True, autoincrement=True)
    flashcard_code = Column(Integer, ForeignKey(
        "flashcards.flashcard_code"), nullable=False)
...
class UserTopic(Base):
    ...
    topic_code = Column(Integer, ForeignKey(
        "topics.topic_code"), primary_key=True)
...
class UserFlashcard(Base):
    ...
    topic_code = Column(Integer, ForeignKey(
        "topics.topic_code"), primary_key=True)
    flashcard_code = Column(Integer, ForeignKey(
        "flashcards.flashcard_code"), primary_key=True)
...
class UserQuestion(Base):
    ...
    topic_code = Column(Integer, ForeignKey(
        "topics.topic_code"), primary_key=True)
    question_code = Column(Integer, ForeignKey(
        "questions.question_code"), primary_key=True)
